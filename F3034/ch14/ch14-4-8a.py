...
ydata = Reference(ws, min_col = 2, min_row = 7, max_row = 10)
xdata = Reference(ws, min_col = 3, min_row = 7, max_row = 10)
size = Reference(ws, min_col = 1, min_row = 7, max_row = 10)
series = Series(values = ydata, xvalues = xdata,
                zvalues = size, title = "2019")
chart.series.append(series)
chart.title = "2018/1019年網路與實體銷售泡泡圖"
chart.x_axis.title = "實體店面"
chart.y_axis.title = "網路商店"
ws.add_chart(chart, "E2")
wb.save("bubbleChart2.xlsx")
wb.close()